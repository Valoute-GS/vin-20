  ...
  constructor() {
   ...
   getMyCollection(): wine[] {
    return [
      ...
      {id: 10, price : 25, name : 'Vin11', note : 17 , description : 'Ceci est une description', type: 'red'},
      {id: 11, price : 12, name : 'Vin12', note : 8 , description : 'Ceci est une description', type: 'rosé'},
      {id: 12, price : 5, name : 'Vin13', note : 2 , description : 'Ceci est une description', type: 'red'},
      {id: 13, price : 56, name : 'Vin14', note : 5 , description : 'Ceci est une description', type: 'white'},
    ]
  }
